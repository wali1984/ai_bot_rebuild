...
- Runtime verification after restarting only `ai-bot-v2-paper-online-runtime.service`: post-lifecycle events = `26`, fills = `0`, fees = `0.0`, old Redis writes = `false`, exchange orders = `false`.
