# Burndown Task 220 — position_context.v2_churn_blocked_rate

Generated: `2026-05-23T00:55:07Z`

GO/NO-GO: `V2_FULL_OBSERVATION_POSITION_CONTEXT_V2_CHURN_BLOCKED_RATE_BURNDOWN_READY_PARTIAL_PROGRESS`

Exact source: `v2:risk:decisions`.

The field now computes the per-symbol true-rate for `churn_blocked` from
matching rows in `v2:risk:decisions`. It no longer consumes raw
