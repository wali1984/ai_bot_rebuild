# Implementation Report - stale_ingestor_arkham_altdata
...
## Raw Evidence
v2_arkham_presence_only_worker --once --json returned PRESENCE_ONLY_PUBLISHED and wrote v2:alt_data:arkham:presence.
