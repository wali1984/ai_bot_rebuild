# Implementation Report — hardcoded_ta_macd_hist
...
## Claim
TA feature `macd_hist` is REAL_COMPUTED in live V2 Redis (pre: hardcoded 0.0). Live value=5.330856239352656. Source: MACD line minus signal over real OHLCV closes.

## Raw evidence
`v2:features:latest:BTCUSDT:1m`.features.macd_hist = 5.330856239352656 (generated_at=2026-06-01T21:50:20Z); BTC snapshot real_feature_count=25, missing_feature_count=0; 27 live v2:features:latest:*:1m keys. Code: v2/backend/app/cli/v2_feature_pipeline_native_loop.py _features_from_market().
