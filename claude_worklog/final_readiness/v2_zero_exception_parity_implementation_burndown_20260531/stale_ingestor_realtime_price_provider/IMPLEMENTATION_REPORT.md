# Implementation Report — stale_ingestor_realtime_price_provider
...
## Raw evidence
`v2:market:prices:BTCUSDT` TTL=516s (<600 ⇒ written within last cycle); ingestor loop --interval-seconds 60.
