# Implementation Report — hardcoded_ta_macd_signal
...
## Claim
TA feature `macd_signal` is REAL_COMPUTED in live V2 Redis (pre: hardcoded 0.0). Live value=-45.87710889551316. Source: EMA(9) of MACD line over real OHLCV closes.

## Raw evidence
`v2:features:latest:BTCUSDT:1m`.features.macd_signal = -45.87710889551316 (generated_at=2026-06-01T21:50:20Z); BTC snapshot real_feature_count=25, missing_feature_count=0; 27 live v2:features:latest:*:1m keys. Code: v2/backend/app/cli/v2_feature_pipeline_native_loop.py _features_from_market().
