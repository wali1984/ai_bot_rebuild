# Implementation Report — hardcoded_ta_htf_rsi_14
...
## Raw evidence
`v2:features:latest:BTCUSDT:1m`.features.htf_rsi_14 = 19.35592315394628 (generated_at=2026-06-01T21:50:20Z); BTC snapshot real_feature_count=25, missing_feature_count=0; 27 live v2:features:latest:*:1m keys. Code: v2/backend/app/cli/v2_feature_pipeline_native_loop.py _features_from_market().
