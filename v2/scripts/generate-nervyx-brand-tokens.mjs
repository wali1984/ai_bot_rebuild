...
const manifest = {
  ...
  modules: {
    sense: { displayName: 'NERVYX SENSE', description: modules['NERVYX SENSE'] },
    core: { displayName: 'NERVYX CORE', description: modules['NERVYX CORE'] },
    shift: { displayName: 'NERVYX SHIFT', description: modules['NERVYX SHIFT'] },
    guard: { displayName: 'NERVYX GUARD', description: modules['NERVYX GUARD'] },
    replay: { displayName: 'NERVYX REPLAY', description: modules['NERVYX REPLAY'] },
    execute: { displayName: 'NERVYX EXECUTE', description: modules['NERVYX EXECUTE'] },
    observe: { displayName: 'NERVYX OBSERVE', description: modules['NERVYX OBSERVE'] },
  },
...
const swiftColorLines = Object.entries(semanticColors)
  .map(([name, value]) => `    public static let ${name} = "${value}"`)
  .join('\n');
