...
- `FRESHNESS_GUARD_BLOCKED_ON_STALE_PUBLIC_ARTIFACTS` [P0_SHUTDOWN_BLOCKER]: stale public latest JSON count=220; remediation=`claude_audit_stale_public_payloads_and_freshness_guard`
...
- symbol universe age seconds: `57`, live_symbols=`[]`
