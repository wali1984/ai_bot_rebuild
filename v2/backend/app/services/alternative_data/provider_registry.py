...
def dashboard_contracts() -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        {**base, "id": "arkham_entity_watchlist_future", "title": "Arkham Entity Watchlist Future", "rank": 6, "future_only_no_integration_today": True},
        {**base, "id": "v2_symbol_universe_altdata_ranking", "title": "V2 Symbol Universe Alt-Data Ranking", "rank": 7},
        {
            **base,
