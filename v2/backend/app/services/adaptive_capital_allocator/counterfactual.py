...
DEFAULT_NOTIONAL_MULTIPLIERS = (0.25, 0.5, 1.0, 1.5)  # conservative notional exploration
DEFAULT_LEVERAGE_VALUES = (1.0, 1.5, 2.0)  # explore up to 2x leverage only (proven models only)
DEFAULT_STOP_MULTIPLIERS = (0.75, 1.0, 1.5)  # standard stops
DEFAULT_TAKE_PROFIT_PLANS = ("none", "one_r", "two_r")  # standard targets
