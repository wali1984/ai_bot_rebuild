...
def _build_portfolio_state_slice(
    ...
    derived.extend(
        [
            ...
            ("portfolio_symbol_smart_money_score", _coerce_float(alt_score.get("smart_money_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("smart_money_score") is not None else "MISSING_FROM_V2_ALTDATA_NANSEN"),
            ("portfolio_symbol_entity_flow_score", _coerce_float(alt_score.get("entity_flow_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("entity_flow_score") is not None else "MISSING_FROM_V2_ALTDATA_NANSEN"),
            ("portfolio_symbol_social_momentum_score", _coerce_float(alt_score.get("social_momentum_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("social_momentum_score") is not None else "MISSING_FROM_V2_ALTDATA_LUNARCRUSH"),
            ("portfolio_symbol_social_volume_velocity", _coerce_float(alt_score.get("social_volume_velocity")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("social_volume_velocity") is not None else "MISSING_FROM_V2_ALTDATA_LUNARCRUSH"),
            ("portfolio_symbol_sentiment_score", _coerce_float(alt_score.get("sentiment_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("sentiment_score") is not None else "MISSING_FROM_V2_ALTDATA_LUNARCRUSH"),
            ...
            ("portfolio_symbol_aicoin_market_activity_score", _coerce_float(alt_score.get("aicoin_market_activity_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("aicoin_market_activity_score") is not None else "MISSING_FROM_V2_ALTDATA_AICOIN"),
            ("portfolio_symbol_aicoin_coin_profile_score", _coerce_float(alt_score.get("aicoin_coin_profile_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("aicoin_coin_profile_score") is not None else "MISSING_FROM_V2_ALTDATA_AICOIN"),
            ("portfolio_symbol_aicoin_order_flow_score", _coerce_float(alt_score.get("aicoin_order_flow_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("aicoin_order_flow_score") is not None else "MISSING_FROM_V2_ALTDATA_AICOIN"),
            ("portfolio_symbol_aicoin_whale_order_score", _coerce_float(alt_score.get("aicoin_whale_order_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("aicoin_whale_order_score") is not None else "MISSING_FROM_V2_ALTDATA_AICOIN"),
            ("portfolio_symbol_aicoin_signal_score", _coerce_float(alt_score.get("aicoin_signal_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("aicoin_signal_score") is not None else "MISSING_FROM_V2_ALTDATA_AICOIN"),
            ("portfolio_symbol_aicoin_drop_radar_score", _coerce_float(alt_score.get("aicoin_drop_radar_score")),
             "V2_ALTDATA_SYMBOL_SCORE_CONTEXT" if alt_score.get("aicoin_drop_radar_score") is not None else "MISSING_FROM_V2_ALTDATA_AICOIN"),
