...
def _dashboard(status: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "false_block_missing_expected_move_count": status.get("false_block_missing_expected_move_count"),
        "false_block_with_expected_move_count": status.get("false_block_with_expected_move_count"),
        "false_block_native_expected_move_count": status.get("false_block_native_expected_move_count"),
        "false_block_unknown_expected_move_source_count": status.get("false_block_unknown_expected_move_source_count"),
        "false_block_classification": status.get("false_block_classification"),
...
def _report(status: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"- false_block_missing_expected_move_count: `{status.get('false_block_missing_expected_move_count')}`",
            f"- false_block_with_expected_move_count: `{status.get('false_block_with_expected_move_count')}`",
            f"- false_block_native_expected_move_count: `{status.get('false_block_native_expected_move_count')}`",
            f"- false_block_unknown_expected_move_source_count: `{status.get('false_block_unknown_expected_move_source_count')}`",
            f"- false_block_classification: `{status.get('false_block_classification')}`",
