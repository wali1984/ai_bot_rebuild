...
def test_assemble_rejects_low_confidence_threshold_above_one() -> None:
    prediction = TrainerPredictionRecord(
        prediction_id="pred_threshold_high",
        feature_snapshot_id="snap_threshold_high",
        symbol="BTCUSDT",
        model_version="model",
    ...
    with pytest.raises(OrchestratorDecisionServiceError) as excinfo:
        assemble_orchestrator_decision_record(
            ...
            low_confidence_threshold=1.0001,
