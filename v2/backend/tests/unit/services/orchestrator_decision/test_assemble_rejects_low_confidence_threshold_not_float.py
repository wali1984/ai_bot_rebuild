...
def test_assemble_rejects_low_confidence_threshold_not_float() -> None:
    prediction = TrainerPredictionRecord(
        prediction_id="pred_threshold_type",
        feature_snapshot_id="snap_threshold_type",
        symbol="BTCUSDT",
        model_version="model",
