...
def test_assemble_rejects_low_confidence_threshold_below_zero() -> None:
    prediction = TrainerPredictionRecord(
        prediction_id="pred_threshold_low",
        feature_snapshot_id="snap_threshold_low",
        symbol="BTCUSDT",
        model_version="model",
    ...
    with pytest.raises(OrchestratorDecisionServiceError) as excinfo:
        assemble_orchestrator_decision_record(
            ...
            low_confidence_threshold=-0.0001,
