...
def test_assemble_priority_worker_over_low_confidence() -> None:
    record = assemble_orchestrator_decision_record(
        prediction=TrainerPredictionRecord(
            prediction_id="pred_priority_worker",
            feature_snapshot_id="snap_priority_worker",
            symbol="BTCUSDT",
            model_version="model",
    ...
    assert record.decision_reason_code == "abstain_worker_degraded"
