...
def test_assemble_deny_orchestrator_abstained_for_abstain_low_confidence() -> None:
    decision = OrchestratorDecisionRecord(
        decision_id="dec_abstain_low_confidence",
        prediction_id="pred_abstain_low_confidence",
        feature_snapshot_id="snap_abstain_low_confidence",
        symbol="BTCUSDT",
        decision_ts_ms=10,
        decision_action="abstain",
        decision_reason_code="abstain_low_confidence",
        input_prediction_direction="long",
        input_prediction_confidence_calibrated=0.05,
    ...
    assert record.input_decision_action == "abstain"
