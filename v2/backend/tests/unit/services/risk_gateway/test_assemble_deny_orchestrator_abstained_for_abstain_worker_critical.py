...
def test_assemble_deny_orchestrator_abstained_for_abstain_worker_critical() -> None:
    decision = OrchestratorDecisionRecord(
        decision_id="dec_abstain_critical",
        prediction_id="pred_abstain_critical",
        feature_snapshot_id="snap_abstain_critical",
        symbol="BTCUSDT",
        decision_ts_ms=10,
        decision_action="abstain",
        decision_reason_code="abstain_worker_critical",
    ...
    assert record.input_decision_reason_code == "abstain_worker_critical"
