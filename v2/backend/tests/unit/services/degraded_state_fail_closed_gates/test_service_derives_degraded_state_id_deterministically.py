...
def _risk_record(decision_id: str) -> RiskDecisionRecord:
...
def test_service_derives_degraded_state_id_deterministically() -> None:
    record = assemble_degraded_state_record(
        upstream_record=_risk_record("decision-LAB-2026-05-10"),
    ...
    assert record.degraded_state_id == "degraded_state:decision-LAB-2026-05-10"
