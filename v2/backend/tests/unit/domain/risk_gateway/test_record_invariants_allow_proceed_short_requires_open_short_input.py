...
def test_allow_proceed_short_requires_open_short_and_proceed_short_input() -> None:
    ...
    assert exc_info.value.reason == "allow_proceed_short_requires_open_short_input"
    ...
    assert exc_info.value.reason == "allow_proceed_short_requires_proceed_short_input_reason"
