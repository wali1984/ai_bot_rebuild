...
def test_compose_handles_stream_names_independently() -> None:
    ...
    assert snapshot.prediction_stream_id_growth == 1
    assert snapshot.proposal_stream_id_growth == 1
