...
def test_compose_populates_proposal_growth_from_matching_stream() -> None:
    snapshot = compose_liveness_snapshot_with_growth(
        base_inputs(),
        prediction_observations=(),
        proposal_observations=(
            obs("proposal", "900-0", 950),
            obs("other", "901-0", 960),
            obs("proposal", "902-0", 970),
        ),
    ...
    assert snapshot.proposal_stream_id_growth == 2
