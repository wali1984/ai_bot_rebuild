...
def test_record_rejects_mirror_deny_default_with_wrong_input_reason() -> None:
    ...
    assert exc_info.value.reason == "mirror_deny_default_requires_deny_default_input_reason"
