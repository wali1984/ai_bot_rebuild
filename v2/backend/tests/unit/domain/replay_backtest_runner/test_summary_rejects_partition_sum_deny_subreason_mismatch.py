...
def test_summary_rejects_partition_sum_deny_subreason_mismatch():
    ...
    assert error.value.field == "record_deny_steps_count"
    assert error.value.reason == "deny_subreason_partition_sum_must_equal_record_deny_steps_count"
