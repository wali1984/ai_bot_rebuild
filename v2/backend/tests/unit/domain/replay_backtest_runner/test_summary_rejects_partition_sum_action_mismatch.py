...
def test_summary_rejects_partition_sum_action_mismatch():
    ...
    assert error.value.field == "total_steps_count"
    assert error.value.reason == "action_partition_sum_must_equal_total_steps_count"
