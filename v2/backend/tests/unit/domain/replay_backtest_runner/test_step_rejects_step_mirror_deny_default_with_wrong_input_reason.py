...
def test_step_rejects_step_mirror_deny_default_with_wrong_input_reason():
    with pytest.raises(ReplayBacktestRunnerDomainError) as error:
        ...
        step_reason_code="step_mirror_deny_default",
    ...
    assert error.value.reason == "step_mirror_deny_default_requires_mirror_deny_default_input_reason"
