...
def test_step_constructs_with_valid_inputs_record_deny_orchestrator_abstained():
    step = ReplayBacktestStep(
        ...
        step_reason_code='step_mirror_deny_orchestrator_abstained',
        input_paper_action='record_deny',
        input_paper_reason_code='mirror_deny_orchestrator_abstained',
        live_blocked=True,
    )
