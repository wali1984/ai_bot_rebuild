def test_evaluator_records_clock_into_risk_decision_ts_ms():
    ...
    evaluator = build_risk_decision_evaluator(now_ms_clock=lambda: 1700000000000)
    result = evaluator(
    ...
    assert result.risk_decision_ts_ms == 1700000000000
