def test_evaluator_propagates_hold_to_deny_orchestrator_held():
    ...
    assert result.risk_reason_code == "deny_orchestrator_held"
    assert result.input_decision_action == "hold"
    assert result.input_decision_reason_code == "hold_flat_direction"
