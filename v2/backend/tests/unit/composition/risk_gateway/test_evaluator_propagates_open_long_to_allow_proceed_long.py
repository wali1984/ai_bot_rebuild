def test_evaluator_propagates_open_long_to_allow_proceed_long():
    ...
    assert result.risk_reason_code == "allow_proceed_long"
    assert result.input_decision_action == "open_long"
    assert result.input_decision_reason_code == "proceed_long"
