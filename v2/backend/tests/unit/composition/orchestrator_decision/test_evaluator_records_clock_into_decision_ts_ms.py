def test_evaluator_records_clock_into_decision_ts_ms() -> None:
    ...
    evaluator = build_orchestrator_decision_evaluator(
        low_confidence_threshold=0.5, now_ms_clock=lambda: 1700000000000
    )
    result = evaluator(
    ...
    assert result.decision_ts_ms == 1700000000000
