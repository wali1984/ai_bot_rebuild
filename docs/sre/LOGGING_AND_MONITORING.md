...
## Purpose
Define logs, runtime artifacts, Redis monitors, Phase K alert matrix, and how to detect stale feeds, stale code, UI mismatch, and forbidden exchange mutation evidence.
