...
## Purpose
Define deployment and rollback checks with runtime drift detection, service restart order, safety gates, and no legacy/paper_online_runtime restart policy.
