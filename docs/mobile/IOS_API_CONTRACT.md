...
## Purpose
Define iOS API fields, mobile paper summary truth, mobile dashboard/risk status fields, and the Swift model/source validation contract.
...
- API: /api/v2/mobile/dashboard
- API: /api/v2/mobile/risk-status
- API: /api/v2/mobile/health
