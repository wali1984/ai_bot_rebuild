# Debugging Trainer Feedback

Last verified timestamp: 2026-07-07T08:04:31Z

## Purpose
Explain how to debug trusted replay, feedback rows, closed trade outcomes, checkpoint writes, and online learning status when trainer alerts fire.
