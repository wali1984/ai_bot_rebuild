...
## Purpose
Define how to add point-in-time safe features with feature_cutoff/available_at ordering, schema versioning, freshness gates, and trainer/replay validation.
