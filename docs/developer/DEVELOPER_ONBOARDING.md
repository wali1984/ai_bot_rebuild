...
## Purpose
Give developers the repository map, runtime safety rules, point-in-time constraints, local validation commands, and artifact locations needed before making changes.
