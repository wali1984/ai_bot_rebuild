...
## Purpose
Define how to add a V2 ingestor safely, including event_time/ingested_at/available_at handling, Redis namespace, freshness monitor, tests, and Santiment-style provider evidence.
