# Website Route Contracts

Last verified timestamp: 2026-07-07T08:04:31Z

## Purpose
Define website route truth contracts, shared RuntimeTruthStrip fields, backend API sources, route crawl validation, and stale-current mismatch handling.
...
- `Website routes: /dashboard /mission-control /markets /symbols /trade /trade/paper /derivatives /signals /ai-predictions /system/model-state /system/trainer /system/risk-controllers /system/readiness /portfolio /executions /history /backtests /admin/*`
