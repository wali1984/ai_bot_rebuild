# ROI And Provider Cost Status

Last verified timestamp: 2026-07-07T08:04:31Z

## Purpose
Explain paid-provider value tracking, including Santiment symbol-selection evidence and the alert fired if paid alternative data is unused.
...
- `v2/backend/app/services/alternative_data/santiment_client.py`
