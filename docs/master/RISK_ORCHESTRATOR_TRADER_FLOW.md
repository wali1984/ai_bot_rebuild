# Risk Orchestrator Trader Flow

Last verified timestamp: 2026-07-07T08:04:31Z

## Purpose
Explain prediction to risk to orchestrator to allocator to paper/live-dry-run lineage and the exact identifiers that must be preserved.
