...
## Purpose
List the evidence gates required before any live canary review, including paper performance, A+ final rows, signed reads, risk packet data, and human approval.
