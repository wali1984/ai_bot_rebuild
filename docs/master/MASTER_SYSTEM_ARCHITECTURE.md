...
## Purpose
Describe the V2 trading bot architecture from ingestors through feature snapshots, trainer, risk/orchestrator, paper execution, live dry-run, APIs, website, iOS, and operator observability.
