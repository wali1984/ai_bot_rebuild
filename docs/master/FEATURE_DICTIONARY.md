...
## Purpose
Define feature families, time fields, lineage identifiers, and the point-in-time constraints required before a feature can feed a decision or trainer sample.
