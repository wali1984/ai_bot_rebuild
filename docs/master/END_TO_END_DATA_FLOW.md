...
## Purpose
Trace event-time safe data flow from market/alternative ingestors to feature availability, prediction, signal, risk, orchestrator, paper execution, trainer feedback, and UI truth.
