...
## Purpose
Give a concise startup checklist for services, Redis truth, paper accounting, trainer status, market freshness, Santiment, frontend, iOS API, and safety gates.
