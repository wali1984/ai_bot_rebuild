...
## Purpose
Define incident response for live gate changes, exchange mutation evidence, stale feeds, stale runtime code, paper_online_runtime activation, and UI truth mismatches.
