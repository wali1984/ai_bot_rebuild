...
> **Current-source reconciliation (2026-07-17):** the numbered findings and code-location narrative below preserve the 2026-07-16 reconstruction and are not a declaration that every defect remains unchanged. The authoritative current delta is [ADAPTIVE_END_TO_END_CONTROL_AND_ACCOUNTING_2026-07-17.md](ADAPTIVE_END_TO_END_CONTROL_AND_ACCOUNTING_2026-07-17.md), with safe checks in [OPERATOR_VALIDATION_AND_MONITORING_RUNBOOK_2026-07-17.md](OPERATOR_VALIDATION_AND_MONITORING_RUNBOOK_2026-07-17.md) and exact test/history provenance in [COMMAND_LEDGER_2026-07-17.md](COMMAND_LEDGER_2026-07-17.md). Source-level mitigations now cover canonical-risk admission, frozen entry/preemptive inputs, chronological label-purged validation, behavior-policy/PPO truth, adaptive paper allocation, post-quantization notional/margin identity, 47-clock allocation PIT validation, account-scoped leverage-bracket evidence, lifecycle capital lineage, halted-probe containment, and outcome-memory time semantics. The intended current source feature generation is 446 ordered fields/1,784 values with a 374-test local trainer/PIT reconciliation; the body below intentionally retains the audited 477/1,908 deployment/history generation, whose checkpoints and replay have not been migrated. These repairs do not establish deployment, live authority, positive expectancy, or A+. The latest measured paper evidence remained `HALTED_PERFORMANCE`: 23 governed closes, PF about 0.704, weighted expectancy about −7.701 bps, and `NO_A_PLUS_SUPPLY`; G11 and corrected G12 were FAIL. The 1000x-in-90-days value remains an unproven research objective, not a guarantee. Read the historical conclusions below through that dated reconciliation.
